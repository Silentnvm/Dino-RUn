...
pygame.display.set_caption("Dino Game By Nitu Tiberiu Florian")
...
while True:
    ...
    if not game_over:
        ...
        player_score += 0.1
        text_score = game_font.render(f"Score: ", True, "black")
        score_rect = text_score.get_rect(center=(1085, 22))
